...
## Root the phylogeny
concattree = read.tree('Rhizobiales_phylogeny_143.treefile')
nfrootedtree = paste('Rhizobiales_phylogeny_143.treefile', 'rooted.names', sep='.')
