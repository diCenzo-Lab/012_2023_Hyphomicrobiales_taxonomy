...
## Root the phylogeny
concattree = read.tree('Rhizobiales_phylogeny_138.treefile')
nfrootedtree = paste('Rhizobiales_phylogeny_138.treefile', 'rooted.names', sep='.')
